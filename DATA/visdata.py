...
def plot_year_data(ax, data, boroughs, year_column, cmap, norm, pollutant):
    ...
    ax.set_title(f'{pollutant} Concentration in London ({year_column.split("_")[0]})')
